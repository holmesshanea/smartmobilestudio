...
uses UntXListBoxItem, Main, Mountain, UntCommon;
...
begin
 ...
 TfrmMountain(Application.FormByName('Mountain')).MtnRange:= RangeArray[ItemIndex+1];
 TfrmMountain(Application.FormByName('Mountain')).Elevation:= ElevArray[ItemIndex+1];
 TfrmMountain(Application.FormByName('Mountain')).Prominence:= PromArray[ItemIndex+1];
 TfrmMountain(Application.FormByName('Mountain')).LatLon:= LatLonArray[ItemIndex+1];
