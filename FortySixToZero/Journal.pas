...
begin
    ...
    application.ShowDialog(aoYesNo,
      procedure (const Dialog: TW3Dialog)
      begin
        Dialog.SetBounds(0,0,ClientWidth,ClientHeight);
        Dialog.Header.Caption := 'Undo';
        Dialog.Text.Caption := 'Are You Sure';
        Dialog.Glyph.GlyphType := lgtFontAwesome;
        Dialog.Glyph.GlyphColor := clWhite;
        Dialog.Glyph.GlyphId := 'fa-5x fa-question';
      end,
...
begin
  ...
  begin
   if Mode = mdRegular then
    ...
    fImage.Url:= 'res\mtn-winter128C.png'
  end
  else
  begin
   if Mode = mdRegular then
    ...
    fImage.Url:= 'res\mtn-winter128.png';
  end;
