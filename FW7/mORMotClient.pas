...
// at 2015-09-19 01:40:31 using "SmartMobileStudio.pas.mustache" template
unit mORMotClient;

{
  WARNING:
    This unit has been generated by a mORMot 1.18.1908 server.
...
type
  ...
  public
    ...
    procedure _ToText(const Value: Currency; const Curr: String; var Sexe: TPeopleSexe; var Name: String);
...
function TPeopleSexeToText(const value: TPeopleSexe): string;
function Variant2TRecordEnum(const _variant: variant): TRecordEnum;
function TRecordEnumToText(const value: TRecordEnum): string;
...
function TPeopleSexeToText(const value: TPeopleSexe): string;
begin
  asm return @TPeopleSexe[@value]; end;
end;
...
function TRecordEnumToText(const value: TRecordEnum): string;
begin
  asm return @TRecordEnum[@value]; end;
end;
...
begin
  result := TSQLModel.Create([TSQLAuthUser,TSQLAuthGroup,TSQLRecordPeople],aRoot);
end;
...
procedure TServiceCalculator._ToText(const Value: Currency; const Curr: String; var Sexe: TPeopleSexe; var Name: String);
begin
